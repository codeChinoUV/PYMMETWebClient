...
export const UploadFiscalSituation = () => {
    ...
    return (
        <div className={styleClass.screenContainer}>
            ...
            <div className={styleClass.containerElements}>
                <p className={styleClass.subtitle}>Constancia de situación fiscal</p>
                <p className={styleClass.text}>
                    Este documento nos permitirá validar la situación fiscal de tu PYME.
                </p>
            </div>
